...
describe("/svelte.js", () => {
    ...
    describe("warnOnUnused", () => {
        it.each([
            [ "link", "./specimens/unused-link.js" ],
            [ "style", "./specimens/unused-style.js" ],
        ...
        it("should ignore unused CSS exports if warnOnUnused isn't set", async () => {
            ...
            const bundle = await rollup({
                input : require.resolve("./specimens/unused-link.js"),
